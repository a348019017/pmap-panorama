...
//       timeLineOption: {
//         yunyaoServerUrl:
//           "https://onemapserver.img.net/onemap/tokens/generateToken?username=hnslyj&password=wxyy@20200827&expiration=30&request=getToken",
//         layerList: yunyao1,
//         timeLineWidth: 500,
...
//           coordinates: [
//             [
//               [112.56695750635149, 28.470394416961657, 0],
//               [112.56540889172099, 28.468437863393685, 0],
//               [112.56917105851095, 28.4676087442739, 0],
//               [112.57010420177261, 28.468528149342944, 0],
//               [112.56944417218834, 28.470134785989625, 0],
//               [112.56866432875786, 28.470523705289533, 0],
//               [112.56866907268041, 28.470528513347684, 0],
//               [112.56695750635149, 28.470394416961657, 0],
//             ],
//           ],
//         },
...
const toolbarDT = [
  {
    ...
    icon: "timePlayer",
    checked: false,
    component: "addMarker.vue",
    description: "添加天地图在线POI",
    hide: false,
    params: {
  ...
  {
    id: "af66ae8e-129d-4861-ac1b-60efb8ef18a3",
    name: "drawpolygon",
    title: "绘制多边形",
    icon: "timePlayer",
    checked: false,
    component: "addMarker2.vue",
    description: "绘制面",
    hide: false,
    params: {
  ...
  {
    id: "af66ae8e-129d-4861-ac1b-60efb8ef18a4",
    name: "drawpolyline",
    title: "绘制线",
    icon: "timePlayer",
    checked: false,
    component: "addMarkerpolyline.vue",
    description: "绘制线",
    hide: false,
    params: {
  ...
  {
    id: "af66ae8e-129d-4861-ac1b-60efb8ef18b4",
    name: "drawpolyline",
    title: "绘制点",
    icon: "timePlayer",
    checked: false,
    component: "addMarkerimage.vue",
    description: "绘制点",
    hide: false,
    params: {
